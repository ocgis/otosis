 ...
 */
  ...
  if( (ret = tos_to_unix( new_fname, filename )) != 0 ) {
	return ret;
  }
...
GEMDOSFUNC(Fsfirst)
{
  ...
  if( (ret = tos_to_unix( tfname, filename )) != 0 ) {
	return ret;
  }
...
GEMDOSFUNC(Frename)
{
  ...
  if( (ret = tos_to_unix( new_src, src )) != 0 ) {
	return ret;
  }
  if( (ret = tos_to_unix( new_dest, dest )) != 0 ) {
	return ret;
  }
...
GEMDOSFUNC(Dcreate)
{
  ...
  if( (ret = tos_to_unix( new_fname, name )) != 0 ) {
	return ret;
  }
...
GEMDOSFUNC(Dsetpath)
{
  ...
  DDEBUG( "  converting: %s\n", src2 );
  if( (ret = tos_to_unix( dest2, src2 )) != 0 ) {
	return ret;
  }
